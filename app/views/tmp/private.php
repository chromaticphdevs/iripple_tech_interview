...
<head>
    ...
    <meta name="description" content="Corefounders project management and equity system">
    <meta name="keywords" content="sass , equity , startup">
...
<body class="vertical-layout" id="internalBackground">
    ...
    <div id="containerbar">
            ...
            <div class="sidebar">
                <div class="navigationbar">
                    <ul class="vertical-menu">
                        ...
                        <li>
                            <a href="<?php echo _route('issue:index')?>">
                                 <i class="feather icon-folder-plus"></i><span>Issues</span>
                                <!-- <span class="badge badge-success pull-right">New</span> -->
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo _route('user:edit' , $user->id)?>">
                        ...
                        <li>
                            <a href="<?php echo _route('user:index')?>">
                                 <i class="feather icon-user"></i><span>User</span>
                                <!-- <span class="badge badge-success pull-right">New</span> -->
                            </a>
                        </li> 

                        <li>
                            <a href="/ReportsController">
                                 <i class="feather icon-user"></i><span>Report</span>
                                <!-- <span class="badge badge-success pull-right">New</span> -->
                            </a>
                        </li> 
                        ...
                        <li>
                            <a href="<?php echo _route('user:logout')?>">
                                 <i class="feather icon-command"></i><span>Logout</span>
                                <!-- <span class="badge badge-success pull-right">New</span> -->
                            </a>
                        </li>
                    </ul>
        ...
        <div class="rightbar">
                                            ...
                                            <div class="input-group">
                                              ...
                                              <div class="input-group-append">
                                                <button class="btn" type="submit" id="button-addon2">
                                                    <img src="<?php echo _path_tmp('images/svg-icon/search.svg')?>" class="img-fluid" alt="search">
                                                </button>
                                              </div>
                                            </div>
                                        </form>
                                    ...
                                    <div class="notifybar">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="notoficationlink">
                                                ...
                                                <ul class="list-unstyled" id="notificationItems">                                                    
                                                ...
                                                <div class="userbox">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="media dropdown-item">
                                                            <a href="<?php echo _route('user:edit' , whoIs('id'))?>" class="profile-icon">
                                                                <img src="<?php echo _path_tmp('images/svg-icon/user.svg')?>" 
                                                                class="img-fluid" alt="user">My Profile</a>
                                                        </li>

                                                        <li class="media dropdown-item">
                                                            <a href="<?php echo _route('user:logout')?>" class="profile-icon">
                                                                <img src="<?php echo _path_tmp('images/svg-icon/logout.svg')?>" 
            ...
            <div class="footerbar">
                <footer class="footer">
                    <p class="mb-0">© 2020 <?php echo COMPANY_NAME?> - All Rights Reserved.</p>
                </footer>
            </div>
            <!-- End Footerbar -->
        </div>
    ...
    <script src="<?php echo _path_tmp('js/custom/custom-table-datatable.js')?>"></script>


    <!-- Core js -->
    <script src="<?php echo _path_tmp('js/core.js')?>"></script>
    ...
    <?php produce('scripts')?>
        <script type="text/javascript">
            ...
            {
                let url = getURL('api/API_Notification/1');
                ...
                $.ajax({
                    ...
                    success: function(response)
                    {
                        ...
                        {
                            htmlData += `<li class="media dropdown-item">
                                <span class="action-icon badge badge-primary-inverse"></span>
                                <div class="media-body">
                                    <a href="${responseData[i].href}"> <h5 class="action-title">${responseData[i].notification}</h5> </a>                            
                                </div>
                            </li>`;
                        }
                        $("#notificationItems").html( htmlData );
                    }
                });
            });
        </script>
